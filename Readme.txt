README for ROBOT BLACK

Installation instructions:
In order to upload my robot on the Robocode environment, you download the gaboneS package into the director that leads to where all the other robots of robocode are stored, which is the C:/robocode/robots path.
Once you have downloaded, you proceed to opening the robocode app, and you select Black which is in the gaboneS package that you will see in the packages section. 
